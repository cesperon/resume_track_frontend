	...
	<div class="popup">
		<div class="popup-inner form text-center justify-content-center">
			...
			<div class="formButtons">
				<button class="btnUpdate fw-bold" v-on:click="submit">Update</button>
				<br>
...
export default {
	...
	data() {
		return {
			user:{
				id: this.apps.id,
				company_name: this.apps.companyName,
				position_name: this.apps.position,
				hiring_manager: this.apps.hiringManager,
				platform: this.apps.platform,
				tech_stack: this.apps.techStack,
				status: this.apps.status,
				compensation: this.apps.compensation,
				experience: this.apps.experience,
				location: this.apps.location,
				state: this.apps.location,
				equity: this.apps.equity,
				salary: this.apps.salary,
				four_O_one: this.apps.fourOOne,
				remote: this.apps.remote,
				description: this.apps.description,
				links: this.apps.links,
				date:this.apps.dateApplied,		
			}
		};
	...
	methods: {
		async submit() {
			...
			await store.dispatch('updateUserApp', this.user );
